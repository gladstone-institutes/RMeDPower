...
### Ex1) Varaince estimation and power calculation from pilot data. Levels will be increased to max(observed level)x5

##### For example, there are 9 experiments in the original data:
